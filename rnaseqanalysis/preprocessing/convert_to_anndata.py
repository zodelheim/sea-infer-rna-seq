...
def read_dataset(
    fname_data: Path | str, fname_header: Path | str, fname_gtf: Path | str, separator=","
):
...
def read_cage_dataset(fname_data: Path | str, fname_header: Path | str, fname_gtf: Path | str):
...
def convert_geuvadis(fname_data: Path | str, fname_header: Path | str, fname_gtf: Path | str):
